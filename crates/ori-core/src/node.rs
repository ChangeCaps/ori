...
impl Node {
    pub fn event_indexed(&mut self, index: usize, cx: &mut EventContext<'_>, event: &Event) {
    ...
    pub fn draw_indexed(&mut self, index: usize, cx: &mut DrawContext<'_>) {
    ...
    pub fn event_padded(&mut self, cx: &mut EventContext<'_>, event: &Event, padding: Padding) {
    ...
    pub fn draw_padded(&mut self, cx: &mut DrawContext<'_>, padding: Padding) {
